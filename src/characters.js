  ...
  const characters = [
    {
      ...
      abilityDescription: "Charge on a green peg, then bend the current ball toward the closest orange peg.",
      accent: "#ffd166",
    ...
    },
    {
      ...
      abilityDescription: "Charge on a green peg, then trigger a shockwave that clears nearby pegs and pops the ball upward.",
      accent: "#ff8f5a",
    ...
    },
    {
      ...
      abilityDescription: "Charge on a green peg, then split the shot into two echo balls for a wider clear.",
      accent: "#69d1ff",
